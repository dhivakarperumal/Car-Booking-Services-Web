...
//         Phone: t.patientSnapshot?.phone,
//         Gender: t.patientSnapshot?.gender,
//         Doctor: t.assignedDoctor,
//         Category: t.category,
//         BillingStatus: t.billingStatus,
//         TotalCost: t.totalVariantCost,
...
//   push(groupByMonth(treatments), "Treatment", "Treatment & Billing Report");
...
//               <th className="px-4 py-4 text-left font-bold ">Report Name</th>
...
//                     className="bg-blue-600 text-white px-3 py-1.5 rounded text-xs flex items-center gap-2"
//                   >
//                     <FaEye /> View
//                   </button>
//                   <button
...
//                   <th className="px-4 py-4 text-left font-bold">Details</th>
//                 </tr>
//               </thead>
//               <tbody>
